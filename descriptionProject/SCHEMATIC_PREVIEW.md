...
`VIN` имеет диапазон 7…12 В DC. На входе обязательны предохранитель 1 А, защита от переполюсовки, TVS, UVLO/OVLO и ограничение тока. `USB_VBUS` — только сервисный источник с лимитом 0,1 А и защитой от обратной подачи. Логические уровни SPI/JTAG/GPIO/RS-485 — 3,3 В.
