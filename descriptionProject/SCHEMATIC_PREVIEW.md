...
| :--- | :--- | :--- | :--- |
| **VCC_5V5** | 5.5 В ±5% | промежуточная/аналоговая часть, fan | Не подключать к цифровым I/O |
...
`VIN` получает 12 В DC от Mean Well NGE12E12-P1J. На входе обязательны предохранитель 1 А, защита от переполюсовки, TVS, UVLO/OVLO и ограничение тока. `USB_VBUS` J4 — только сервисный источник с лимитом 0,1 А и защитой от обратной подачи. Логические уровни SPI/JTAG/GPIO/RS-485 — 3,3 В.
